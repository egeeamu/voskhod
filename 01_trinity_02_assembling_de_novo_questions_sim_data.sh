...
../bin/trinityrnaseq-2.2.0/Trinity --seqType fq --single ."$R1" --CPU "$cores" --max_memory "$maxram"G | tee ../logs/logs_trinity_R1_R2.txt
...
mkdir -p assembly/raw/trinity
cd ./trinity_part_"$name"
../bin/trinityrnaseq-2.2.0/Trinity --seqType fq --left ."$R1" --right ."$R2" --CPU "$cores" --max_memory "$maxram"G | tee ../logs/logs_trinity_R1_R2.txt
...
mkdir -p assembly/raw/trinity
cd ./trinity_part_"$name"
../bin/trinityrnaseq-2.2.0/Trinity --seqType fq --single ."$R1" --SS_lib_type R --CPU "$cores" --max_memory "$maxram"G | tee ../logs/logs_trinity_R1_R2.txt
#../bin/trinityrnaseq-2.2.0/Trinity --seqType fq --single ."$R1" --normalize_reads --CPU "$cores" --max_memory "$maxram"G | tee ../logs/logs_trinity_R1_R2.txt
...
mkdir -p assembly/raw/trinity
cd ./trinity_part_"$name"
../bin/trinityrnaseq-2.2.0/Trinity --seqType fq --left ."$R1" --right ."$R2" --SS_lib_type RF --CPU "$cores" --max_memory "$maxram"G | tee ../logs/logs_trinity_R1_R2.txt
#nice -n "$nicevalue" ../bin/trinityrnaseq-2.2.0/Trinity --seqType fq --left ."$R1" --right ."$R2" --normalize_reads --CPU "$cores" --max_memory "$maxram"G | tee ../logs/logs_trinity_R1_R2.txt
