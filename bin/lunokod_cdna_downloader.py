...
specie = "drerio_gene_ensembl" # dyakuba_eg_gene , drerio_gene_ensembl, dmelanogaster_eg_gene
...
os.system("mkdir ./data_input >/dev/null 2>/dev/null")
#os.system("rm -rf ./data_input/cdna_infos.db.tmp")
...
os.system("rm -rf ./data_input/cdna_infos.db")
