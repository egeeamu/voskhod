...
os.system("rm -rf ./bin/SPAdes")
os.system("tar xf ./bin/SPAdes.tar.gz -C ./bin/")
...
while match is not None:
    ...
    if totalhits > 1:
        try:
            ...
            os.system("./bin/SPAdes/bin/spades.py -t 8 --careful --disable-gzip-output --only-assembler --cov-cutoff auto -s ./runass/runfq.fq -o ./runass >/dev/null 2>/dev/null")
            #os.system("./bin/SPAdes/bin/spades.py -t 8 --careful --disable-gzip-output --cov-cutoff auto -s ./runass/runfq.fq -o ./runass >/dev/null 2>/dev/null")
            #os.system("./bin/SPAdes/bin/spades.py -t 8 --cov-cutoff auto --untrusted-contigs ./runass/runfa.fa.cap.contigs.fasta -s ./runass/runfq.fq -o ./runass >/dev/null 2>/dev/null")
            print "Done"
        except:
